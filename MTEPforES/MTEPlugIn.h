...
const ColorSetting SETTING_COLOR_RVSM_O = { "Color/RvsmO", TAG_COLOR_DEFAULT };
const ColorSetting SETTING_COLOR_RVSM_X = { "Color/RvsmX", TAG_COLOR_DEFAULT };
const ColorSetting SETTING_COLOR_RVSM_V = { "Color/RvsmV", TAG_COLOR_DEFAULT };
